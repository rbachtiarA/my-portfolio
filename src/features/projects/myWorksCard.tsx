...
export default function MyWorksCard({ item } :{item: MyProjectItem}) {
  return (
    <div className="px-4 md:px-7 w-full space-y-4">
        ...
        <div className="md:flex space-y-4">
            <div className="md:w-1/2 flex items-center justify-center">
                <img className="rounded-md border-slate-200 border-[1px] h-[200px] object-cover" loading="lazy" src={item.mainImage || '/'} alt={item.title} width={400} height={200}/>
            </div>
